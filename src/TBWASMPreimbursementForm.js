...
import logo from './tbwa-logo.png'; // Ensure the path to your logo is correct
...
const TBWASMPreimbursementForm = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <img src={logo} alt="TBWA Logo" className="h-12 mb-4" />
        ...
        {receiptPreview && (
          <div className="flex flex-wrap -mx-3 mb-2">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              ...
              <img src={receiptPreview} alt="Receipt Preview" className="mt-2" />
            </div>
          </div>
        )}
        {error && (
      ...
      <div className="mb-4">
        ...
        <p>Category: {newExpense.category}</p>
